...
const _require5 = require(`./recipes`),
      recipesHandler = _require5.recipesHandler;
...
function isLocalGatsbySite() {
  ...
  try {
    const _require6 = require(path.resolve(`./package.json`)),
          dependencies = _require6.dependencies,
          devDependencies = _require6.devDependencies;
...
module.exports = argv => {
  ...
  try {
    const _require8 = require(`../package.json`),
          version = _require8.version;
  ...
  return cli.command({
    ...
    handler: handlerP(({
      ...
      const _require9 = require(`./init-starter`),
            initStarter = _require9.initStarter;
