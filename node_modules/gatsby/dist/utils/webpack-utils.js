...
var _gatsbyWebpackStatsExtractor = _interopRequireDefault(require("./gatsby-webpack-stats-extractor"));

var _gatsbyWebpackEslintGraphqlSchemaReloadPlugin = _interopRequireDefault(require("./gatsby-webpack-eslint-graphql-schema-reload-plugin"));
...
const createWebpackUtils = (stage, program) => {
  ...
  plugins.extractStats = options => new _gatsbyWebpackStatsExtractor.default(options);

  plugins.eslintGraphqlSchemaReload = options => new _gatsbyWebpackEslintGraphqlSchemaReloadPlugin.default(options);
