...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__EventDispatcher__ = __webpack_require__(18);
...
var ScrollElement = function (_React$Component) {
  ...
  function ScrollElement(props) {
    ...
    _this.getParam = function (e) {
      _this.clientHeight = _this.target ? _this.target.clientHeight : Object(__WEBPACK_IMPORTED_MODULE_10__util__["h" /* windowHeight */])();
      ...
      var playScale = Object(__WEBPACK_IMPORTED_MODULE_10__util__["g" /* transformArguments */])(_this.props.playScale);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__Tween__ = __webpack_require__(63);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_style_utils__ = __webpack_require__(64);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__easing__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__plugins__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__plugin_StylePlugin__ = __webpack_require__(118);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ScrollOverPack__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ScrollParallax__ = __webpack_require__(116);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ScrollLink__ = __webpack_require__(122);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ScrollScreen__ = __webpack_require__(123);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_rc_tween_one__ = __webpack_require__(117);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TweenOne__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Tween__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__TweenOneGroup__ = __webpack_require__(121);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__easing__ = __webpack_require__(65);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__TweenOne__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__util__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_tween_functions__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_tween_functions___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_tween_functions__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_raf__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_raf___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_raf__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__EventDispatcher__ = __webpack_require__(18);
...
var passive = Object(__WEBPACK_IMPORTED_MODULE_4__util__["c" /* getPassive */])();

var ScrollScreenClass = function ScrollScreenClass() {
  var _this = this;

  __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default()(this, ScrollScreenClass);
  ...
  this.init = function (vars) {
    ...
    _this.toHeight = -1;
    _this.num = 0;
    if (__WEBPACK_IMPORTED_MODULE_4__util__["i" /* windowIsUndefined */]) {
      return;
    }
    __WEBPACK_IMPORTED_MODULE_3__EventDispatcher__["a" /* default */].addEventListener('wheel.scrollWheel', _this.onWheel, null, passive);
    // dom 在 didMount 后高度没出来，加 setTimeout; 
    setTimeout(_this.startScroll);
  };

  this.unMount = function () {
    __WEBPACK_IMPORTED_MODULE_3__EventDispatcher__["a" /* default */].removeEventListener('wheel.scrollWheel', _this.onWheel);
  };
  ...
  this.startScroll = function () {
    ...
    _this.mapped = mapped;
    _this.scrollTop = Object(__WEBPACK_IMPORTED_MODULE_4__util__["a" /* currentScrollTop */])();
    _this.animEndScrollTop = _this.scrollTop;
    _this.setCurrentNNum();
    if (mapped[0] && mapped[0].offsetTop >= Object(__WEBPACK_IMPORTED_MODULE_4__util__["h" /* windowHeight */])()) {
    ...
    if (_this.toHeight !== _this.scrollTop) {
      _this.initTime = Date.now();
      _this.rafID = __WEBPACK_IMPORTED_MODULE_2_raf___default()(_this.raf);
    } else {
      _this.toHeight = -1;
    }
  };
  ...
  this.raf = function () {
    ...
    var now = Date.now();
    var progressTime = now - _this.initTime > duration ? duration : now - _this.initTime;
    var easeValue = __WEBPACK_IMPORTED_MODULE_1_tween_functions___default.a[_this.vars.ease](progressTime, _this.scrollTop, _this.toHeight, duration);
  ...
  this.cancelRequestAnimationFrame = function () {
    __WEBPACK_IMPORTED_MODULE_2_raf___default.a.cancel(_this.rafID);
    _this.rafID = -1;
  };
